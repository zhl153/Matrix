...
public class ReportDialog extends Dialog {
    private int cx;
    private int cy;
    private RecyclerView mRecyclerView; // 获得reference
    private ReportRecyclerViewAdapter mRecyclerViewAdapter;
    private ViewSwitcher mViewSwitcher; // 调用switcher
    ...
    interface DialogCallBack { // 定义event callback
    ...
    protected void onCreate (Bundle savedInstanceState) {
        ...
        getWindow().setBackgroundDrawable(new ColorDrawable(android.graphics.Color.TRANSPARENT)); // 无background背景透明
    ...
    private void setupRecyclerView(View dialogView) {
        ...
        mRecyclerView.setLayoutManager(new GridLayoutManager(getContext(), 3)); // 使用gridlayout，3列
    ...
    private void setUpEventSpecs(final View dialogView) {
        ...
        mSendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mDialogCallBack.onSubmit(mCommentEditText.getText().toString(), mEventype); // 返回信息
            }
        });
